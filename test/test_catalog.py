...
def test_resolve_added_curated_profiles() -> None:
    ...
    assert bundle.resolve_target("ts").themes == ["core", "frontend", "testing"]
    assert bundle.resolve_target("ts-mcp").themes == ["core", "frontend", "mcp", "testing", "mcp-agents"]
    ...
    assert bundle.resolve_target("scientific-programming").themes == bundle.resolve_target("science").themes
