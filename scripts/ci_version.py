...
def apply_version(version: str, *, dry_run: bool) -> None:
    _replace_once(PYPROJECT, PYPROJECT_VERSION_RE, version, dry_run=dry_run)
    _replace_once(CARGO_TOML, WORKSPACE_SECTION_RE, version, dry_run=dry_run)
    _replace_once(CPM_MANIFEST, CPM_PACKAGE_SECTION_RE, version, dry_run=dry_run)
    _replace_once(INIT_FILE, INIT_VERSION_RE, version, dry_run=dry_run)
